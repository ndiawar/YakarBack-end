...
export const registerUser = async (req, res) => {
  ...
  try {
    ...
    // Récupérer l'utilisateur connecté (celui qui est en session, qui effectue l'inscription)
    ...
    // Enregistrer l'action d'inscription dans l'historique avec l'utilisateur connecté
