 ...
 *     description: Filtre les données pour la semaine contenant la date spécifiée (Lundi à Dimanche). Format de la date : YYYY-MM-DD.
 *     tags:
 *       - "collecte"
 *     parameters:
 *       - in: path
 *         name: date
 *         required: true
 *         description: Date au format YYYY-MM-DD pour filtrer la semaine (Lundi à Dimanche).
 *         schema:
 *           type: string
 *           example: "2024-11-20"
 *     responses:
